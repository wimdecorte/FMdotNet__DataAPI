...
Updated for FileMaker Server 17's official release of the Data API.
...
Note that the FileMaker Server 17 version of the Data API is very different than the one with FileMaker Server 16.
Also the FileMaker Server 16 Data API will stop working in September 2018.
...
See this repo for a demo application: https://github.com/wimdecorte/FMdotNet__DataAPI_demo for FileMaker Server 16
